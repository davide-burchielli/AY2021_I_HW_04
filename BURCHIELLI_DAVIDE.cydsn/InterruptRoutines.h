...
*/
    ...
    // Create macro for the 2 MUX channels
    #define PHOTOR 0         // The MUX channel 0 is used to acquire the Photoresistor signal
    #define POTENTIOMETER 1  // The MUX channel 1 is used to acquire the Potentiometer signal    
    
    #define BYTE_TO_SEND 4   // Macro that identifies the number of bytes to send
    ...
    volatile _Bool Channel;          // Channel variable identifies the current channel of the MUX
